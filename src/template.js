module.exports = function() {
  ...
  return function(h) {
    ...
    if (this.opts.edgeNavigation && this.totalChunks > 1) {
      firstPage = <li class={`VuePagination__pagination-item ${theme.item} VuePagination__pagination-item-prev-chunk`}>
      <a class={theme.link} 
      href="javascript:void(0);"
      on-click={this.setPage.bind(this, 1)}>{this.opts.texts.first}</a>
      </li>
      
      lastPage = <li class={`VuePagination__pagination-item ${theme.item} VuePagination__pagination-item-prev-chunk`}>
      <a class={theme.link} 
      href="javascript:void(0);"
